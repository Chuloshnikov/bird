...
const Carousel = () => {
    ...
    return (
        <section className='hidden md:block'>
            <div className='flex items-center justify-center text-3xl pt-20 font-bold md:pb-10 px-10 bg-gradient-to-r from-blue-500 to-green-300 bg-clip-text text-transparent'>
